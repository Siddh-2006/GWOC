            ...
            {tabs.map((tab) => {
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`relative px-3 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl flex items-center gap-1 sm:gap-2 font-semibold text-xs sm:text-sm transition-all duration-300 whitespace-nowrap flex-1 justify-center ${
                    isActive
